...
const KIND = {
  say: { icon: '💬', label: 'พูดกับลูกค้า', cls: 'bg-blue-50 border-blue-200 text-blue-900' },
  do: { icon: '✅', label: 'ลงมือทำ', cls: 'bg-slate-50 border-slate-200 text-slate-800' },
  insight: { icon: '🧠', label: 'ระบบวิเคราะห์', cls: 'bg-violet-50 border-violet-200 text-violet-900' },
  upsell: { icon: '💰', label: 'โอกาสขาย', cls: 'bg-emerald-50 border-emerald-200 text-emerald-900' },
}
